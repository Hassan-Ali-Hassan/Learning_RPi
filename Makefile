...
all: demo_raw demo_dmp demo_3d YAW

HDRS = helper_3dmath.h I2Cdev.h MPU6050_6Axis_MotionApps20.h MPU6050.h demo_3d.h -lrt
...
$(CMN_OBJS) $(DMP_OBJS) $(DMPY_OBJS) $(RAW_OBJS) : $(HDRS)
